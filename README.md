...
* [☕ 후원하기 (Support)](#support-kr)
* [📸 스크린샷 (Screenshots)](#screenshots-kr)
* [✨ 주요 기능 (Key Features)](#features-kr)
* [💻 테스트 및 구동 환경 (Tested Environment)](#environment-kr)
* [🚀 시작하기 (Getting Started)](#getting-started-kr)
* [🔧 최근 업데이트 내역 (Recent Updates)](#updates-kr)
* [🛡️ 보안 및 백신 오탐지 안내 (Security)](#security-kr)
* [⚠️ 면책 조항 (Disclaimer)](#disclaimer-kr)
* [📢 채널 및 문의 (Contact)](#contact-kr)

---

## <a id="support-kr"></a>☕ 후원하기 (Support)
...
* **자동 업데이트 및 릴리즈 노트 지원:** 프로그램 실행 시 최신 버전을 감지하여, 업데이트가 필요할 경우 테러존 표시 패널 하단에 최신 버전 정보와 함께 **'⚡ 자동 업데이트'** 및 **'📄 릴리즈 노트'** 확인 버튼을 직관적으로 표출합니다.
...
## <a id="environment-kr"></a>💻 테스트 및 구동 환경 (Tested Environment)
이 프로그램은 아래의 환경에서 개발 및 테스트되었습니다. 사용자의 디스플레이 설정이나 게임 화면 모드에 따라 오버레이 위치가 미세하게 어긋나거나 클릭 통과 기능에 차이가 발생할 수 있습니다.

* **OS:** Windows 11 Pro 25H2 (64-bit)
* **Display:** 2560x1440 (QHD)
* **Game:** 디아블로 2: 레저렉션 (주로 '전체화면 모드'에서 테스트하며, 창모드 지원을 위해 필요에 따라 '창모드' 테스트 병행 / *권장 사항: 전체화면 모드*)
* **Build:** Python 3.14

---

## <a id="getting-started-kr"></a>🚀 시작하기
...
2.  **디아블로 2: 레저렉션**을 실행합니다. (전체화면 모드 권장)
...
## <a id="security-kr"></a>🛡️ 보안 및 백신 오탐지 안내 (Security)
...
## <a id="disclaimer-kr"></a>⚠️ 면책 조항 (Disclaimer)
...
## 📑 Table of Contents
* [☕ Support (Donation)](#support-en)
* [📸 Screenshots](#screenshots-en)
* [✨ Key Features](#features-en)
* [💻 Tested Environment](#environment-en)
* [🚀 Getting Started](#getting-started-en)
* [🔧 Recent Updates](#updates-en)
* [🛡️ Security & False Positives](#security-en)
* [⚠️ Disclaimer](#disclaimer-en)
* [📢 Contact](#contact-en)

---

## <a id="support-en"></a>☕ Support (Donation)
...
* **Auto-Update & Release Notes:** Automatically checks for the latest version upon startup. If a new version is available, the latest version number along with **'⚡ Auto-Update'** and **'📄 Release Notes'** buttons will be intuitively displayed just below the Terror Zone panel.
...
## <a id="environment-en"></a>💻 Tested Environment
This program was developed and tested in the following environment. Depending on your display settings or in-game display mode, the overlay position may slightly shift, or the click-through functionality may vary.

* **OS:** Windows 11 Pro 25H2 (64-bit)
* **Display:** 2560x1440 (QHD)
* **Game:** Diablo 2: Resurrected (Primarily tested in 'Fullscreen Mode', with supplementary testing in 'Windowed Mode' to ensure compatibility / *Recommended: Fullscreen Mode*)
* **Build:** Python 3.14
...
2. Run **Diablo 2: Resurrected**. (Fullscreen Mode is recommended)
3. Run `d2_tz.exe`.
...
## <a id="security-en"></a>🛡️ Security & False Positives
...
## <a id="disclaimer-en"></a>⚠️ Disclaimer
